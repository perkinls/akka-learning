 ...
 * @title 观察Actor停止
 */
public class WatchActorStop extends UntypedActor {
...
class WorkerActor extends UntypedActor {
    ...
    public static void main(String[] args) {
        ...
        ActorRef ref = system.actorOf(Props.create(WatchActorStop.class), "watchActor");
        /**
         * 使用stop、PoisonPill.getInstance()、Kill.getInstance()停止Actor
         */
//        system.stop(ref);
